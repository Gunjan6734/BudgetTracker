...
public class ExportExpenseDatabaseCSVTask extends AsyncTask<String ,String, String> {
...
String fileName="";
    ...
    public ExportExpenseDatabaseCSVTask(Context context,
                                        String[] columnsArray,
                                        List<String> dateList,
                                        List<String> amountList,
                                        List<String> categoryList,
...
//        System.out.println(dbFile);  // displays the data base path in your logcat
        ...
        try {
            ...
            for(int m = 0; m< categoryList.size(); m++){
                sourceDataList.add(new String[]{"Category", categoryList.get(m)});
            }
            ...
            for(int m=0; m<typeList.size(); m++){
                typeDataList.add(new String[]{"Transaction Type", typeList.get(m)});
            }
            csvWrite.writeAll(typeDataList);
